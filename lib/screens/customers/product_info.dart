       ...
       sizeproducts_radio_button.add(
             ...
             Row(
               children: <Widget>[
                 ...
                 Text(arr[i],style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
               ],
             ),
                ...
                Row(
                  children: <Widget>[
                    ...
                    DropdownButton<String>(
                      hint: Text('Please choose quantity'), // Not necessary for Option 1
                      value: quantity,
...
print('if');
                  Products_purchased.add(Order(
                      ...
                      pMediaUrl: product_info.pMediaUrl,
